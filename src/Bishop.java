public class Bishop extends ChessPiece {
    ...
    public boolean canMoveToPosition(ChessBoard chessBoard, int line, int column, int toLine, int toColumn) {
        // проверка, что мы можем перейти на позицию и не можем выйти с доски или в непустую позицию
        if (line != toLine && column != toColumn &&
            ...
            // с левого верхнего угла в правый нижний угол
            if ((column == getMin(column, toColumn) && line == getMax(line, toLine)) ||
                ...
                // с левого нижнего угла в правый верхний угол
