...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Играем в шахматы по очереди игроки вводят координаты фигур: \n'exit' - для выхода\n'replay' - для перезапуска игры\n'castling0' или 'castling7' - для рокировки по соответствующей линии\n'move 1 1 2 3' - для передвижения фигуры с позиции x y на  x y");System.out.println();
        board.printBoard();
        while (true) {
